...
<div class="mx-auto max-w-3xl px-4 py-10">
	...
	<dl class="mt-8 grid gap-4 sm:grid-cols-2">
		<div class="border-line rounded-xl border bg-white p-5">
			...
			<dd class="font-display text-ink mt-1 text-lg font-bold">{SITE.whatsapp}</dd>
			<Button
				variant="whatsapp"
				class="mt-3 w-full"
		...
		<div class="border-line rounded-xl border bg-white p-5">
			...
			<dd class="font-display text-ink mt-1 text-lg font-bold">{SITE.telepon}</dd>
			<Button variant="outline" class="mt-3 w-full" href={telUrl(SITE.telepon)}
		...
		<div class="border-line rounded-xl border bg-white p-5 sm:col-span-2">
			...
			<dd class="font-display text-ink mt-1 text-lg font-bold">
				<a href="mailto:{SITE.email}" class="hover:text-primary">{SITE.email}</a>
			</dd>
		</div>
	</dl>
</div>
